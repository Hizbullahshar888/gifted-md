...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "923278974102", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "923278974102", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "𝓗𝓘𝓩𝓑𝓤𝓛𝓛𝓐𝓗", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "ᴀʟᴀɴ ᴡᴀʟᴋᴇʀ", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "ᴍᴀᴅᴇ ʙʏ", // Added // Input Yours custom...
...
AUTO_BLOCK: process.env.AUTO_BLOCK || "212", // Add Multiple Country Codes Separated by Comma...
